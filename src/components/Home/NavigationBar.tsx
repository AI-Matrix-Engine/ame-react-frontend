...
export const NavigationBar = ({textColor,hoverColor,text=null,opacity}:navigationBar) => {
  
  return (
    <div>
      {menuItems.map((item, index) => (
        <div key={index}>
          <h4 className={`${opacity} text-[#92959b]  text-left text-xs font-bold `}>{text? text : item.category}</h4>
